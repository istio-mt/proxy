...
load("//bazel:gitlab.bzl", "GITLAB_TOKEN", "GITLAB_URL", "GITLAB_PROJECT_ID")
load(
...
ENVOY_SHA = "c904f0f0a00011a3fe272dc2eb5d51787e969483"
...
git_repository(
    name = "envoy",
    commit = ENVOY_SHA,
    remote = "https://user:" + GITLAB_TOKEN + "@" + GITLAB_URL + "/" + ENVOY_ORG + "/" + ENVOY_REPO + ".git",
)
